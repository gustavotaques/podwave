...
CREATE TABLE `avaliacoes` (
  ...
  `avacomentario` mediumtext DEFAULT NULL,
...
(1,1,0,5,NULL,'2025-06-22 00:00:00',4),
(6,4,4,3,'nota atribuida ao episodio 4','2025-07-03 22:14:49',4);
...
(1,1,0,'Aqui eu farei o primeiro comentario','2025-06-22 00:00:00',4),
(2,1,0,'oi','2025-06-22 00:00:00',4),
(3,1,0,'terceiro','2025-06-22 00:00:00',4),
(8,3,4,'comentario numero 5 sobre o episodio','2025-07-03 22:14:49',4);
...
CREATE TABLE `episodios` (
  ...
  `epiaudio` varchar(255) DEFAULT NULL,
...
(2,9,'Episódio 1','Primeiro episódio','/images/figura02.jpg',30,'2025-06-19 00:00:00','ativo',NULL,1,0,NULL,150,NULL),
(4,19,'Fluminense bate Ulsan','Teste para trigger','teste 3',120,'2025-07-04 00:00:00','ativo','2025-07-04 17:54:39',0,0,1,0,'episodio1.mp3');
...
CREATE TABLE `podcasts` (
  ...
  `poddescricao` mediumtext DEFAULT NULL,
...
(9,'Inovação Hoje','Explorando ideias disruptivas','/images/figura02.jpg',4,1),
(10,'CineCult','Análises profundas do cinema independente','/images/figura02.jpg',6,2),
(11,'ArenaCast','Debates esportivos com especialistas','/images/figura02.jpg',3,3),
(12,'Mentes Curiosas','Descubra curiosidades do mundo','/images/figura02.jpg',2,4),
(13,'GameZone','Notícias e reviews do mundo gamer','/images/figura02.jpg',5,5),
(14,'Planeta Verde','Conversas sobre meio ambiente e sustentabilidade','/images/figura02.jpg',7,6),
(15,'Nota Musical','Entrevistas e lançamentos musicais','/images/figura02.jpg',8,7),
(16,'Café com História','Fatos e personagens que marcaram o mundo','/images/figura02.jpg',2,8),
(17,'Código Aberto','Programação, software livre e tecnologia','/images/figura02.jpg',6,9),
(19,'Teste','apenas um teste atualizado 2','/images/figura02.jpg',1,10),
(21,'Teste 1000','este teste é 10','/images/figura02.jpg',1,9),
(23,'cafe com dados','discussoes sobre o impacto dos dados no dia a dia','/images/figura01.jpg',4,1),
(24,'historias do amanha','narrativas sobre possiveis futuros','/images/figura02.jpg',8,2),
(25,'voz da ciencia','entrevistas com cientistas renomados','/images/figura03.jpg',3,3),
(26,'tecnologia explicada','conceitos tecnologicos para leigos','/images/figura04.jpg',5,4),
(27,'debate esportivo','comentarios sobre jogos e jogadores','/images/figura05.jpg',4,5);
...
/*!50001 CREATE VIEW `progresso_por_episodio` AS SELECT
 NULL AS `usunome`,
 NULL AS `epititulo`,
 NULL AS `podnome`,
 NULL AS `proprogresso`,
 NULL AS `prodata` */;
...
INSERT INTO `progresso_reproducao` VALUES
(1,3,2,51,'2025-07-03 22:14:49');
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8mb4;
/*!50001 CREATE VIEW `resumo_favoritos_usuario` AS SELECT
 NULL AS `usunome`,
 NULL AS `epititulo`,
 NULL AS `podnome`,
 NULL AS `catnome` */;
...
(1,'Gustavo','gustavo@gmail.com','123','admin'),
(2,'Joao','joao@gmail.com','123','comum'),
(3,'Jose','jose@gmail.com','123','comum'),
(4,'Julia','julia@gmail.com','123','comum'),
(5,'Josivaldo','josivaldo@gmail.com','123','comum'),
(6,'Luisa','luisa@gmail.com','123','comum'),
(7,'Alan','alan@gmail.com','123','comum'),
(8,'Test User','test@example.com','password123','comum');
...
-- Dump completed on 2026-06-11 22:43:35
